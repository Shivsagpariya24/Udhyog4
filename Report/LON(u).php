...
<?php
   if(isset($_POST['submit'])) 
  {
    ...
    $query="UPDATE lon SET d_no='$d_no',dd='$dd',i_d='$i_d',a_d='$a_d',i_n='$i_n',a_n='$a_n'  where id=".$ourid;
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../Report/LON.php"><img class="img-fluid mr-3"
