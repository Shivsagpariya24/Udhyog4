...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../list_of_standard.php"><img class="img-fluid mr-3" src="../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <input type="button" id="btnExport" value="Print" class="float-right mr-2 mt-2" download/>
                ...
                <script type="text/javascript">
                    ...
                    html2canvas($('#tblCustomers')[0], {
                        onrendered: function (canvas) {
                            ...
                            pdfMake.createPdf(docDefinition).download("Standard.pdf");
                        }
                        });
                       });
                </script>
            ...
            <tr style="height:35px;border-color:#000000;">
                       ...
                       <th >Master List</th>
                       <th >Format:QR/ML/0</th>
                </tr>
                <tr style="height:35px;border-color:#000000;">
                <th >List of Standard</th>
                <th >Revision No : 0</th>
                </tr>
                <table>
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2">
                 ...
                 <?php
                $sql = "SELECT  id,no,year,des,old_edition,l_version,upl FROM los"; //You don't need a ; like you do in SQL
        ...
        <tr  style="height: 35px">
            ...
            <td><?php echo $row['old_edition']?> </td>
            <td><?php echo $row['l_version']?> </td>
            <td style="text-align: left; font-weight: bold;"><a style="text-decoration-line: none;color: black" href="../upload/st/<?php echo $row['upl']?>"><?php echo $row['upl']?></a> </td>
        </tr>
<?php
}
echo "</table>";
...
<table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2">
<tr style="height:35px;border-color:#000000;">
        <th colspan="3">Prepaid By : </th>
        <th colspan="3">As On</th>
