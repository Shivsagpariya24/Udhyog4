...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <script type="text/javascript">
                    ...
                    html2canvas($('#tblCustomers')[0], {
                        onrendered: function (canvas) {
                            ...
                            pdfMake.createPdf(docDefinition).download("Technical.pdf");
                        }
                        });
                       });
                </script>
           ...
           <div id="tblCustomers">
            ...
            <table border="2" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2">
