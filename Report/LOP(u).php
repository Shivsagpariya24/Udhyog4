...
<?php
   if(isset($_POST['submit'])) 
  {
    ...
    $em=$_POST['em'];
    $pa=$_POST['pa'];
    $query="UPDATE lop SET et='$et',nm='$nm',des='$des',sp='$sp',ex='$ex',rt='$rt',ln='$ln',mn='$mn',em='$em',pa='$pa'  where id=".$ourid;
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../Report/LOP.php"><img class="img-fluid mr-3"
