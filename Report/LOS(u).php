...
<?php
   if(isset($_POST['submit'])) 
  {
    ...
    $year= $_POST['year'];
    $des= $_POST['des'];
    $old_edition= $_POST['old_edition'];
    $l_version= $_POST['l_version'];
    $query="UPDATE los SET no='$no',year='$year',des='$des',old_edition='$old_edition',l_version='$l_version'  where id=".$ourid;
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../Report/LOS.php"><img class="img-fluid mr-3"
