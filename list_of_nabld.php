...
<?php
    ...
    if (isset($_REQUEST['d_no'])) {
        ...
        $dd    = stripslashes($_REQUEST['dd']);
        $dd    = mysqli_real_escape_string($con, $dd);
        $i_d    = stripslashes($_REQUEST['i_d']);
        $i_d    = mysqli_real_escape_string($con, $i_d);
        $a_d    = stripslashes($_REQUEST['a_d']);
        $a_d    = mysqli_real_escape_string($con, $a_d);
        $i_n    = stripslashes($_REQUEST['i_n']);
        $i_n    = mysqli_real_escape_string($con, $i_n);
        $a_n    = stripslashes($_REQUEST['a_n']);
        $a_n    = mysqli_real_escape_string($con, $a_n);

        $query    = "INSERT into `lon` (d_no,dd,i_d,a_d,i_n,a_n)
                    VALUES ('$d_no','$dd','$i_d','$a_d','$i_n','$a_n')";
        $result   = mysqli_query($con, $query);
        if ($result) {
            ?>
                <script>
                    alert ('your data will be successfully submit');
                    location.replace('list_of_nabld.php');
                </script>
    ...
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <a href="life_of-nabld.php" class="abc ml-5">New</a>
                            <a href="Modify/LON.php" class="abc ml-5">Modify</a>
                            <a href="Report/LOn.php" class="abc ml-5">Report</a>
                            </div>
                            </div>
                            <div class="">
        ...
        <div class="form ml-3">
           ...
           <div class="col-4">
                ...
                <div class="col-4">
                    <label>Doument Description</label>
                    <input type="text" name="dd" class="form-control">
                </div>
                <div class="col-4">
                    <label>Issue Date</label>
                    <input type="date" name="i_d" class="form-control">
                </div>
            </div>
        <br>
            <div class="row">
                ...
                <div class="col-4">
                    <label>Amend No</label>
                    <input type="text" name="a_n" class="form-control">
                </div>               
