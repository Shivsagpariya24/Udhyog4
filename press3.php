...
<html>
<head>
	<title>Udhyog4.0 LLP | Press3</title>
	<meta charset="utf-8">
                ...
                <div class="col-11">
        			...
        			<nav >
						<div class="nav nav-tabs nav-fill "  role="tablist"> 
							...
							<a class="nav-item nav-link press2"style="background-color:#E6E7E8;text-decoration:none; color:black;font-weight: bold" >Press 3</a>
							<a class="nav-item nav-link press3" style="background-color:#E6E7E8;text-decoration:none; color:black;font-weight: bold" href="press4.php">Press 4</a>
