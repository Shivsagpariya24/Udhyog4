...
<?php
    ...
    if (isset($_REQUEST['dt'])) {
        ...
        $ven    = stripslashes($_REQUEST['ven']);
        $ven    = mysqli_real_escape_string($con, $ven);
        $s_n    = stripslashes($_REQUEST['s_n']);
        $s_n    = mysqli_real_escape_string($con, $s_n);
        $par    = stripslashes($_REQUEST['par']);
        $par    = mysqli_real_escape_string($con, $par);
        ...
        $query    = "INSERT into `qr28` (dt,ven,s_n,par,des,sig,remark)
                    VALUES ('$dt','$ven','$s_n','$par','$des','$sig','$remark')";
        $result   = mysqli_query($con, $query);
        if ($result) {
            ?>
                <script>
                    alert ('your data will be successfully submit');
                    location.replace('qr-28.php');
                </script>
	...
	<div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <a href="qr28.php" class="abc ml-5">New</a>
                            <a href="modify/qr28.php" class="abc ml-5">Modify</a>
                            <a href="report/qr28.php" class="abc ml-5">Report</a>
                            </div>
                            </div>
                            <div class="">
        ...
        <form action="" method="post" enctype="multipart/form-data">
           ...
           <div class="col-4">
                ...
                <div class="col-4">
                    <label>Venue</label>
                    <input type="text" name="ven" class="form-control">
                </div>
                <div class="col-4">
                    <label>S. No.</label>
