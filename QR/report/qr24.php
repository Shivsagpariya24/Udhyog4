...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../qr-24.php"><img class="img-fluid mr-3" src="../../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <script type="text/javascript">
                    ...
                    html2canvas($('#tblCustomers')[0], {
                        onrendered: function (canvas) {
                            ...
                            pdfMake.createPdf(docDefinition).download("QR_8.pdf");
                        }
                        });
                       });
                </script>
            ...
            <tr style="height: 35px">
                 <th>No</th>
                 <th>Clauses Audited</th>
                   <th>Month</th>
                 </tr> 
                 <?php
                $sql = "SELECT  id,c_a,mon FROM qr24"; //You don't need a ; like you do in SQL
