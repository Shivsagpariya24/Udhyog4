...
<?php
  ...
  {
    $id=$_POST['id'];
    $doc_des= $_POST['doc_des'];
    $dep= $_POST['dep'];
    

    $query="UPDATE qr2 SET doc_des='$doc_des',dep='$dep'  where id=".$ourid;
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../qr-2.php"><img class="img-fluid mr-3"
