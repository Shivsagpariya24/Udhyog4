...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <script type="text/javascript">
                    ...
                    html2canvas($('#tblCustomers')[0], {
                        onrendered: function (canvas) {
                            ...
                            pdfMake.createPdf(docDefinition).download("QR_1.pdf");
                        }
                        });
                       });
                </script>
            <div id="tblCustomers">
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: black;" class="mr-2 mt-5" >
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2">
                 ...
                 <?php
                $sql = "SELECT  id,r_n,dt,des,dep,doc,doc_n,det,roc FROM qr1";
