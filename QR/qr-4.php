...
<?php
    ...
    if (isset($_REQUEST['par'])) {
        ...
        $query    = "INSERT into `qr4` (par,sig,remark)
                    VALUES ('$par','$sig','$remark')";
        $result   = mysqli_query($con, $query);
        if ($result) {
            ?>
                <script>
                    alert ('your data will be successfully submit');
                    location.replace('qr-4.php');
                </script>
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <a href="qr-4.php" class="abc ml-5">New</a>
                            <a href="modify/qr4.php" class="abc ml-5">Modify</a>
                            <a href="report/qr4.php" class="abc ml-5">Report</a>
                            </div>
                            </div>
                            <div class="">
