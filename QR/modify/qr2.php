...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../qr-2.php"><img class="img-fluid mr-3" src="../../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <tr style="height: 35px">
                 ...
                 <?php
                $sql = "SELECT  id,doc_des,dep,upl FROM qr2"; //You don't need a ; like you do in SQL
            ...
            <td><?php echo $row['doc_des']?> </td>
            <td><?php echo $row['dep']?> </td>
            <td style="text-align: left; font-weight: bold;"><a style="text-decoration-line: none;color: black" href="../File/qr2/<?php echo $row['upl'] ?>" ><?php echo $row['upl']?></a> </td>
            
            <?php
                            echo "
                            <td><a href='../report/qr2(u).php?id=$row[id]&doc_des=$row[doc_des]&dep=$row[dep]&upl=$row[upl]'>update</td>
                            ";
                    ?> 
        </tr>
<?php
