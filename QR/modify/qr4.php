...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../qr-4.php"><img class="img-fluid mr-3" src="../../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2 mt-3" >
                 ...
                 <?php
                $sql = "SELECT  id,par,sig,remark FROM qr4"; //You don't need a ; like you do in SQL
        ...
        <tr  style="height: 35px">
            ...
            <?php
               echo "
               <td><a href='../report/qr4(u).php?id=$row[id]&par=$row[par]&sig=$row[sig]&remark=$row[remark]'>update</td>
               ";
               ?> 
        </tr>
