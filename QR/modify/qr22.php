...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../qr-22.php"><img class="img-fluid mr-3" src="../../img/SW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <tr style="height: 35px">
                 ...
                 <?php
                $sql = "SELECT  id,dt,c_n,c_d,r_c,a_p,remark,sig FROM qr22"; //You don't need a ; like you do in SQL
            ...
            <?php
                            echo "
                            <td><a href='../report/qr22(u).php?id=$row[id]&dt=$row[dt]&c_n=$row[c_n]&c_d=$row[c_d]&r_c=$row[r_c]&
                            a_p=$row[a_p]&remark=$row[remark]&sig=$row[sig]'>update</td>
                            ";
                    ?> 
        </tr>
<?php
