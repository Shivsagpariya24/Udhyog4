    ...
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../qr-3.php"><img class="img-fluid mr-3" src="../../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <tr style="height: 35px">
                 ...
                 <th>Name</th>
                   ...
                   <th>Qualification</th>
                   <th>Experience </th>
                   <th>Field of Testing</th>
                   <th>Training Required</th>
                   <th>Remarks</th>
                   <th>Update</th>
                 </tr> 
                 <?php
                $sql = "SELECT  id,nm,des,qua,exp,f_test,req,remark FROM qr3"; //You don't need a ; like you do in SQL
            ...
            <td><?php echo $row['f_test']?> </td>
            <td><?php echo $row['req']?> </td>
            <td><?php echo $row['remark']?> </td>
            
            <?php
                            echo "
                            <td><a href='../report/qr3(u).php?id=$row[id]&nm=$row[nm]&des=$row[des]&qua=$row[qua]&exp=$row[exp]&
                            f_test=$row[f_test]&req=$row[req]&remark=$row[remark]'>update</td>
                            ";
                    ?> 
        </tr>
<?php
