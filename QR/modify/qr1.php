    ...
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../../Formats.php"><img class="img-fluid mr-3" src="../../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2 mt-3" >
                 ...
                 <th>Requisitioner Name</th>
                   ...
                   <th>Document / Format No.</th>
                   <th>Details of change required</th>
                   <th>Reason of Change</th>
                   <th>Update</th>
                 </tr> 
                 <?php
                $sql = "SELECT  id,r_n,dt,des,dep,doc,doc_n,det,roc FROM qr1"; //You don't need a ; like you do in SQL
            ...
            <td><?php echo $row['r_n']?> </td>
            <td><?php echo $row['dt']?> </td>
            <td><?php echo $row['des']?> </td>
            <td><?php echo $row['dep']?> </td>
            <td><?php echo $row['doc']?> </td>
            <td><?php echo $row['doc_n']?> </td>
            <td><?php echo $row['det']?> </td>
            <td><?php echo $row['roc']?> </td>
            <?php
                            echo"
                            <td><a href='../report/qr1(u).php?id=$row[id]&r_n=$row[r_n]&dt=$row[dt]&des=$row[des]&dep=$row[dep]&
                            doc=$row[doc]&doc_n=$row[doc_n]&det=$row[det]&roc=$row[roc]'>update</td>
                            ";
                    ?> 
        </tr>
