...
<?php
    ...
    if (isset($_REQUEST['tr_mo'])) {
        // removes backslashes
        $tr_mo = stripslashes($_REQUEST['tr_mo']);
        $tr_mo = mysqli_real_escape_string($con, $tr_mo);
        ...
        $query    = "INSERT into `qr5` (tr_mo,mon,remark)
                    VALUES ('$tr_mo','$mon','$remark')";
        $result   = mysqli_query($con, $query);
        if ($result) {
            ?>
                <script>
                    alert ('your data will be successfully submit');
                    location.replace('qr-5.php');
                </script>
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <a href="qr-5.php" class="abc ml-5">New</a>
                            <a href="modify/qr5.php" class="abc ml-5">Modify</a>
                            <a href="report/qr5.php" class="abc ml-5">Report</a>
                            </div>
                            </div>
                            <div class="">
