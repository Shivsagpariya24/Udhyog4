...
<?php
    ...
    if (isset($_REQUEST['r_n'])) {
        // removes backslashes
        $r_n = stripslashes($_REQUEST['r_n']);
        $r_n = mysqli_real_escape_string($con, $r_n);
        ...
        $dep    = stripslashes($_REQUEST['dep']);
        $dep    = mysqli_real_escape_string($con, $dep);
        $doc    = stripslashes($_REQUEST['doc']);
        $doc    = mysqli_real_escape_string($con, $doc);
        $doc_n  = stripslashes($_REQUEST['doc_n']);
        $doc_n  = mysqli_real_escape_string($con, $doc_n);
        $det    = stripslashes($_REQUEST['det']);
        $det    = mysqli_real_escape_string($con, $det);
        $roc    = stripslashes($_REQUEST['roc']);
        $roc    = mysqli_real_escape_string($con, $roc);
        
        $query    = "INSERT into `qr1` (r_n,dt,des,dep,doc,doc_n,det,roc)
                    VALUES ('$r_n','$dt','$des','$dep','$doc','$doc_n','$det','$roc')";
        $result   = mysqli_query($con, $query);
        if ($result) {
            ?>
                <script>
                    alert ('your data will be successfully submit');
                    location.replace('Formats.php');
                </script>
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <a href="Formats.php" class="abc ml-5">New</a>
                            <a href="QR/modify/qr1.php" class="abc ml-5">Modify</a>
                            <a href="QR/report/qr1.php" class="abc ml-5">Report</a>
                            </div>
                            </div>
                            <div class="">
                    ...
                    <div class="float-left btn-group" style="width: 8.5%;background-color: white; height: 585px; ">
                        <div class="nav nav-tabs nav-fill "  role="tablist">
                            ...
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-2.php">QR_02</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-3.php">QR_03</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-4.php">QR_04</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-5.php">QR_05</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-20.php">QR_20</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-24.php">QR_24</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-25.php">QR_25</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-26.php">QR_26</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-27.php">QR_27</a>
                            <a class="nav-item nav-link press" style="text-decoration:none; color:black;font-weight: bold" href="QR/qr-28.php">QR_28</a>
