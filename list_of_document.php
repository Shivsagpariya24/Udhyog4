...
<?php
    ...
    if (isset($_REQUEST['name'])) {
        ...
        $c_no    = stripslashes($_REQUEST['c_no']);
        $c_no    = mysqli_real_escape_string($con, $c_no);
        $remark    = stripslashes($_REQUEST['remark']);
        $remark    = mysqli_real_escape_string($con, $remark);

        $query    = "INSERT into `lod` (name,d_no,c_no,remark)
                    VALUES ('$name','$d_no','$c_no','$remark')";
        $result   = mysqli_query($con, $query);
        if ($result) {
            ?>
                <script>
                    alert ('your data will be successfully submit');
                    location.replace('list_of_document.php');
                </script>
	...
	<div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <a href="list_of_document.php" class="abc ml-5">New</a>
                            <a href="Modify/LOD.php" class="abc ml-5">Modify</a>
                            <a href="Report/LOD.php" class="abc ml-5">Report</a>
                            </div>
                            </div>
                            <div class="">
        ...
        <form action="" method="post" enctype="multipart/form-data">
           ...
           <div class="col-4">
                ...
                <div class="col-4">
                    <label>Current Revision No</label>
