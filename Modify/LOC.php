...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../list_of_cr.php"><img class="img-fluid mr-3" src="../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2 mt-3" >
                 ...
                 <?php
                $sql = "SELECT  id,md,ut,sou,mk,tc,dt,upl FROM loc"; //You don't need a ; like you do in SQL
        ...
        <tr  style="height: 35px">
            ...
            <td><?php echo $row['sou']?> </td>
            <td><?php echo $row['mk']?> </td>
            <td><?php echo $row['tc']?> </td>
            <td><?php echo $row['dt']?> </td>
            <td style="text-align: left; font-weight: bold;"><a style="text-decoration-line: none;color: black" href="../upload/cr/<?php echo $row['upl'] ?>" ><?php echo $row['upl']?></a> </td>
            
            <?php
               echo "
               <td><a href='../Report/LOC(u).php?id=$row[id]&md=$row[md]&ut=$row[ut]&sou=$row[sou]&mk=$row[mk]&tc=$row[tc]&dt=$row[dt]&upl=$row[upl]'>update</td>
               ";
               ?> 
        </tr>
