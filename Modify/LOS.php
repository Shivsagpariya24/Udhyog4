...
<head>
    <title>
        Udhyog4.0 LLP | List of Standards
    </title>
    <meta charset="utf-8">
...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
        ...
        <tr  style="height: 35px">
            ...
            <?php
               echo "
               <td><a href='../Report/LOS(u).php?id=$row[id]&n=$row[no]&y=$row[year]&d=$row[des]&oe=$row[old_edition]&lv=$row[l_version]&upl=$row[upl]'>update</td>
               ";
               ?> 
        </tr>
