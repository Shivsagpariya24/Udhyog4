...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../list_of_tp.php"><img class="img-fluid mr-3" src="../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2 mt-3" >
                 ...
                 <?php
                $sql = "SELECT  id,title,d_no,r_no,i_no,i_date,re_no,p_no,np,upl FROM lot"; //You don't need a ; like you do in SQL
        ...
        <tr  style="height: 35px">
            ...
            <td style="text-align: left; font-weight: bold;"><a style="text-decoration-line: none;color: black" href="../upload/tp/<?php echo $row['upl'] ?>" ><?php echo $row['upl']?></a> </td>
            
            <?php
               echo "
               <td><a href='../Report/LOT(u).php?id=$row[id]&title=$row[title]&d_no=$row[d_no]&r_no=$row[r_no]&i_no=$row[i_no]&i_date=$row[i_date]&re_no=$row[re_no]&p_no=$row[p_no]&np=$row[np]'>update</td>
               ";
               ?> 
        </tr>
