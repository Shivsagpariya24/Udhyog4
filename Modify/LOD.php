...
<head>
    <title>
        Udhyog4.0 LLP | List of Document
    </title>
    <meta charset="utf-8">
...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../list_of_document.php"><img class="img-fluid mr-3" src="../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2 mt-3" >
                 ...
                 <?php
                $sql = "SELECT  id,name,d_no,c_no,remark FROM lod"; //You don't need a ; like you do in SQL
        ...
        <tr  style="height: 35px">
            ...
            <?php
               echo "
               <td><a href='../Report/LOD(u).php?id=$row[id]&nm=$row[name]&d=$row[d_no]&c=$row[c_no]&rm=$row[remark]'>update</td>
               ";
               ?> 
        </tr>
