...
<body style="background-color: #E6E7E8">
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../list_of_nabld.php"><img class="img-fluid mr-3" src="../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2 mt-3" >
                 ...
                 <?php
                $sql = "SELECT  id,d_no,dd,i_d,a_d,i_n,a_n FROM lon"; //You don't need a ; like you do in SQL
        ...
        <tr  style="height: 35px">
            ...
            <td><?php echo $row['a_n']?> </td>
            <?php
               echo "
               <td><a href='../Report/LON(u).php?id=$row[id]&d_no=$row[d_no]&dd=$row[dd]&i_d=$row[i_d]&a_d=$row[a_d]&i_n=$row[i_n]&a_n=$row[a_n]'>update</td>
               ";
               ?> 
        </tr>
