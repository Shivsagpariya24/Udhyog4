    ...
    <div class="container-fluid">
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <div class="">
                                <a href="../list_of_record.php"><img class="img-fluid mr-3" src="../img/QSW.png" style="width: 45px;">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <table border="1" bgcolor="white" align="center" style="text-align: center; width: 92%;border-color: lightgray;" class="mr-2 mt-3" >
                 ...
                 <tr style="height: 35px">
                   <th>No</th>
                   <th>Records held with</th>
                   <th>Records</th>
                   <th>Format No</th>
                   <th>Ratention Period</th>
                   <th>Update</th>
                 </tr> 
                 <?php
                $sql = "SELECT  id,rh,rec,fn,rp FROM lor"; //You don't need a ; like you do in SQL
        ...
        <tr  style="height: 35px">
            ...
            <?php
               echo "
               <td><a href='../Report/LOR(u).php?id=$row[id]&rh=$row[rh]&rec=$row[rec]&fn=$row[fn]&rp=$row[rp]'>update</td>
               ";
               ?> 
        </tr>
