...
<?php
    ...
    if (isset($_REQUEST['name'])) {
        ...
        $final_file = "upload/ia/".$upl;
        $upload = move_uploaded_file($tmp_name,$final_file);

        $query    = "INSERT into `loi` (name,qua,upl)
                    VALUES ('$name','$qua','$upl')";
        ...
        if ($result) {
            ?>
                <script>
                    ...
                    location.replace('list_of_ia.php');
                </script>
                ...
                <div class="col-11">
                    ...
                    <div class="row mt-2" style="font-size: 23px;">
                        <div class="col-12 d-flex justify-content-between align-items-center"
                            ...
                            <a href="list_of_ia.php" class="abc ml-5">New</a>
                            <a href="Modify/LOA.php" class="abc ml-5">Modify</a>
                            <a href="Report/LOA.php" class="abc ml-5">Report</a>
                            </div>
                            </div>
                            <div class="">
